        ...
        <div class="bulletin">
          ...
          <ul v-if="seller.supports" class="supports">
            <li class="support-item border-1px" v-for="(item,index) in seller.supports">
              ...
              <ThePictureTwo :score="index"></ThePictureTwo>
...
<script type="text/ecmascript-6">
  ...
  import {saveToLocal, loadFromLocal} from '@/common/js/store';//在localStorage存状态
  ...
  export default {
    name: "merchant",
    components: {ThePictureTwo, Split, Star, TheTail},
    props:{
      seller:{
        type:Object
      }
