<template>
  <!--评论页面-->
  <div class="rat">
    <div class="ratings" ref="evaLuate">
...
<script>
  ...
  export default {
    name: "commodity",
    components: {Ratselect, Split, Star, TheTail},
    props:{
      seller:{
        type:Object
      }
    ...
    methods:{
      _initScroll(){
        this.evaScorll=new BScroll(this.$refs.evaLuate,{
          // click: false
          click:true
        });
      },
